...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2024 at 10:04 AM
...
INSERT INTO `season` (`ID`, `name`, `state`, `startDate`) VALUES
(1, 'winter 2025', 'on', '2025-01-15');
...
(1, 'admin', 1012345678, 'admin@gmail.com', 'admin', 'admin123');
...
--
ALTER TABLE `sport`
  ADD CONSTRAINT `sport_ibfk_1` FOREIGN KEY (`supervisorID`) REFERENCES `trainer` (`ID`),
  ADD CONSTRAINT `sport_ibfk_2` FOREIGN KEY (`supervisorID`) REFERENCES `trainer` (`ID`);
